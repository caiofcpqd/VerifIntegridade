...
DWORD ObterTamanhoDoModulo(DWORD Module)
{
...
bool MemSeguro(uint8_t* destino, DWORD enderecoBase, size_t tamanho)
{
    size_t offset = 0;
...
void CheckRegiao(DWORD Regiao, DWORD Tamanho)
{
...
DWORD WINAPI ACThread(LPVOID lp)
{
	...
	{
		DWORD ADDR_REG = (DWORD)reg.Endereco;
		DWORD ADDR_SIZ = (DWORD)reg.Tamanho;
